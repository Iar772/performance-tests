...
open_debit_card_account_request: OpenDebitCardAccountRequest = OpenDebitCardAccountRequest(
...
make_top_up_operation_request: MakeTopUpOperationRequest = MakeTopUpOperationRequest(
...
create_operation_receipt_request: GetOperationReceiptRequest = GetOperationReceiptRequest(
...
get_operation_receipt_response: GetOperationReceiptResponse = operations_gateway_service.GetOperationReceipt(
    create_operation_receipt_request
)
